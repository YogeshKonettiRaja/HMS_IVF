<html>
    ...
    <body>
           <form action="reportsclass.php" name="branchform" id="branchform">
            <div class="mb-3" style="text-align:center;font-size:20px;background-color:#ec008c;color:white;">PATIENT FULL DETAIL REPORTS</div>
                <fieldset>
                <div class="row">
                <div class="col-4">
                ...
                <div class="col-3">
                   <button type="button" style="margin-top:30px;background-color:#96488b;color:white;" name="pressearch" id="pressearch" class="btn btn-primary">Search</button>
                </div>
                </div>
                </fieldset>
           </form>
